...
public class Canvas
{
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    //To add new colors, follow the pattern below, adding another else if statement and //
    ...
    public void setForegroundColor(int alpha, String colorString)
    {
        if(colorString.equals("red"))
            ...
            graphic.setColor(new Color(116, 78, 171, alpha));
        else if(colorString.equals("silver"))
            graphic.setColor(new Color(204, 214, 222, alpha));
        else if(colorString.equals("dark yellow"))
            graphic.setColor(new Color(231, 152, 63, alpha));
        else if(colorString.equals("light green"))
            graphic.setColor(new Color(121, 178, 84, alpha));
        else
            graphic.setColor(Color.black);
    }
    ...
    private class ShapeDescription
    {
        ...
        public void draw(Graphics2D graphic)
        {
            ...
            {
                rotation = Math.toRadians(((Ellipse)obj).getRotation());
                alpha = ((Ellipse)obj).getTransparency();
            }
