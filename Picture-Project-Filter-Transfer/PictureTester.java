...
public class PictureTester
{
  ...
  /** Method to test raySeparation */
  public static void testRaySeparation() {
      Picture beach = new Picture("beach.jpg");
      Picture blueMotorcycle = new Picture("blueMotorcycle.jpg");
      beach.explore();
      beach.raySeparation(blueMotorcycle, 8);
      beach.explore();
  }
  
  /** Method to test mandelbrotSeparation */
  public static void testMandelbrotSeparation() {
      Picture beach = new Picture("beach.jpg");
      Picture blueMotorcycle = new Picture("blueMotorcycle.jpg");
      beach.explore();
      beach.mandelbrotSeparation(blueMotorcycle);
      beach.explore();
  }
  
  /** Method to test sinCosSeparation */
  public static void testSinCosSeparation() {
      Picture beach = new Picture("beach.jpg");
      Picture blueMotorcycle = new Picture("blueMotorcycle.jpg");
      beach.explore();
      beach.sinCosSeparation(blueMotorcycle);
      beach.explore();
  }
  
  /** Method to test spiralSeparation */
  public static void testSpiralSeparation() {
      Picture beach = new Picture("beach.jpg");
      Picture blueMotorcycle = new Picture("blueMotorcycle.jpg");
      beach.explore();
      beach.spiralSeparation(blueMotorcycle);
      beach.explore();
  }
